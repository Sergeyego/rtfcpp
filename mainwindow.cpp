...
void MainWindow::createDoc(TableModel &heater, TableModel &content, QString filename)
{
    ...
    rtfWriter.set_tablecellformat(borderFormat);
    rtfWriter.start_tablerow();
    rtfWriter.start_tablecell(1670,RtfWriter::NO_MERGE,RtfWriter::BEGIN_MERGE);
    ph->paragraphAligment=1;
    rtfWriter.start_paragraph(QString::fromUtf8("Дата составления"),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(2350,RtfWriter::NO_MERGE,RtfWriter::BEGIN_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8("Код вида операции"),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(3030,RtfWriter::NO_MERGE,RtfWriter::BEGIN_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8("Склад"),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(8133,RtfWriter::BEGIN_MERGE,RtfWriter::NO_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8("Поставщик"),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(8983,RtfWriter::MERGE,RtfWriter::NO_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(10117,RtfWriter::NO_MERGE,RtfWriter::BEGIN_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8("Страховая компания"),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(10967,RtfWriter::BEGIN_MERGE,RtfWriter::NO_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8("Корреспондирующий счет"),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(12101,RtfWriter::MERGE,RtfWriter::NO_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(13235,RtfWriter::BEGIN_MERGE,RtfWriter::NO_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8("Номер документа"),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(14367,RtfWriter::MERGE,RtfWriter::NO_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(15047,RtfWriter::NO_MERGE,RtfWriter::BEGIN_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.end_tablerow();

    rtfWriter.start_tablerow();
    rtfWriter.start_tablecell(1670,RtfWriter::NO_MERGE,RtfWriter::MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(2350,RtfWriter::NO_MERGE,RtfWriter::MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(3030,RtfWriter::NO_MERGE,RtfWriter::MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    ...
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(10117,RtfWriter::NO_MERGE,RtfWriter::MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    ...
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(15047,RtfWriter::NO_MERGE,RtfWriter::MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.end_tablerow();
    ...
    ph->CHARACTER.fontSize=16;
    rtfWriter.start_tablerow();
    rtfWriter.start_tablecell(5103,RtfWriter::BEGIN_MERGE,RtfWriter::NO_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8("Материальные ценности"),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(5953,RtfWriter::MERGE,RtfWriter::NO_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(6823,RtfWriter::BEGIN_MERGE,RtfWriter::NO_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8("Единица измерения"),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(7847,RtfWriter::MERGE,RtfWriter::NO_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(8863,RtfWriter::BEGIN_MERGE,RtfWriter::NO_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8("Количество"),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(9883,RtfWriter::MERGE,RtfWriter::NO_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(10743,RtfWriter::NO_MERGE,RtfWriter::BEGIN_MERGE);
    ...
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(11603,RtfWriter::NO_MERGE,RtfWriter::BEGIN_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8("Сумма без учета НДС, руб. коп."),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(12465,RtfWriter::NO_MERGE,RtfWriter::BEGIN_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8("Сумма НДС, руб. коп."),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(13323,RtfWriter::NO_MERGE,RtfWriter::BEGIN_MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8("Всего с учетом НДС, руб. коп."),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(14183,RtfWriter::NO_MERGE,RtfWriter::BEGIN_MERGE);
    ...
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(10743,RtfWriter::NO_MERGE,RtfWriter::MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(11603,RtfWriter::NO_MERGE,RtfWriter::MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(12465,RtfWriter::NO_MERGE,RtfWriter::MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(13323,RtfWriter::NO_MERGE,RtfWriter::MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(14183,RtfWriter::NO_MERGE,RtfWriter::MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    rtfWriter.end_tablecell();
    rtfWriter.start_tablecell(15047,RtfWriter::NO_MERGE,RtfWriter::MERGE);
    rtfWriter.start_paragraph(QString::fromUtf8(""),false);
    ...
    tf->marginTop=RtfWriter::fromMmSize(0.5);
    tf->marginBottom=RtfWriter::fromMmSize(0.5);
    tf->marginLeft=RtfWriter::fromMmSize(0.5);
    tf->marginRight=RtfWriter::fromMmSize(0.5);
            ...
            if (list.at(1).toInt()==0){
                ...
                if (ok){
                    ...
                    if (list.at(3).toInt()==1){
                        queryCont=QString::fromUtf8("select e.marka||' '||'ф'||p.diam|| "
                                                    "CASE WHEN p.id_var<>1 THEN ' /'||ev.nam ||'/' ELSE '' END "
                                                    "||' ('||ep.pack_ed||')', p.n_s, w.kvo from parti_pack as w "
                        ...
                        queryCont=QString::fromUtf8("select e.marka||' '||'ф'||p.diam || "
                                                    "CASE WHEN p.id_var<>1 THEN ' /'||ev.nam ||'/' ELSE '' END, "
                                                    "p.n_s, w.kvo from parti_break as w "
                                                    "inner join parti as p on p.id=w.id_part "
                                                    "inner join elrtr as e on e.id=p.id_el "
                                                    "inner join elrtr_vars ev on ev.id = p.id_var "
                                                    "where w.id_nakl = ? order by w.id");
                ...
                if (ok){
                    ...
                    queryCont=QString::fromUtf8("select e.marka||' '||'ф'||p.diam || "
                                                "CASE WHEN p.id_var<>1 THEN ' /'||ev.nam ||'/' ELSE '' end "
                                                "||' ('||ep.pack_ed||')', p.n_s, w.kvo from prod as w "
                                                "inner join parti as p on p.id=w.id_part "
                                                "inner join elrtr as e on e.id=p.id_el "
                                                "inner join el_pack as ep on ep.id=p.id_pack "
                                                "inner join elrtr_vars ev on ev.id = p.id_var "
                ...
                if (ok){
                    ...
                    queryCont=QString::fromUtf8("select e.marka||' '||'ф'||p.diam || "
                                                "CASE WHEN p.id_var<>1 THEN ' /'||ev.nam ||'/' ELSE '' end "
                                                "||' ('||ep.pack_ed||')', p.n_s, w.kvo from prod_self_items as w "
                                                "inner join parti as p on p.id=w.id_part "
                                                "inner join elrtr as e on e.id=p.id_el "
                                                "inner join el_pack as ep on ep.id=p.id_pack "
                                                "inner join elrtr_vars ev on ev.id = p.id_var "
                ...
                if (ok){
                    QString queryCont;
                    queryCont=QString::fromUtf8("select 'из '||e.marka||' '||'ф'||p.diam|| "
                                                "CASE WHEN p.id_var<>1 THEN ' /'||ev.nam ||'/' ELSE '' end "
                ...
                if (ok){
                    ...
                    queryCont=QString::fromUtf8("select (e.marka||' '||'ф'||p.diam || "
                                                "CASE WHEN p.id_var<>1 THEN ' /'||ev.nam ||'/' ELSE '' end "
                                                "||' ('||ep.pack_ed||')') as nme, p.n_s, sum(w.kvo) "
                                                "from prod as w "
                                                "inner join parti as p on p.id=w.id_part "
                                                "inner join elrtr as e on e.id=p.id_el "
                                                "inner join el_pack as ep on ep.id=p.id_pack "
